...
class Running(Training):
    ...
    coeff_calorie_1 = 18 #Константа, для формулы расхожов каллорий 
    coeff_calorie_2 = 20 #Константа, для формулы расхожов каллорий 
...
class Swimming(Training):
    ...
    coeff_calorie_5 = 1.1 #Константа, для формулы расходов каллорий 
    coeff_calorie_6 = 2 #Константа, для формулы расходов каллорий 
...
def read_package(workout_type: str, data: list) -> Training:
    ...
    workout_types: Dict = {'RUN': Running,
                     'WLK': SportsWalking,
                     'SWM': Swimming}
